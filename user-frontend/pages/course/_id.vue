      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box">
            <img :src="courseWebVo.cover" :alt="courseWebVo.title" class="dis c-v-pic" style="width: 640px; height: 357px;">
          </section>
        </article>
          ...
          <div class="i-box">
            <div>
              ...
              <section class="stud-act-list">
                <ul style="height: auto; min-height: 100px;">
                  <li>
                    <div class="u-face">
                      <a href="#">
...
export default {
  ...
  methods: {
    ...
    addComment() {
      // 1.判断是否登录
      const isLogin = cookie.get('edu_token')
      if (!isLogin) {
        this.$message({
          type: 'info',
          message: '请先登录'
