              ...
              <li v-for="item in data.items" :key="item.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a title="开始学习" class="comm-btn c-btn-1" @click="routeEnter(item.id)">开始学习</a>
                    </div>
                  </section>
                  <h3 class="hLh30 txtOf mt10">
                    <a :title="item.title" class="course-title fsize18 c-333" @click="routeEnter(item.id)">{{ item.title }}</a>
                  </h3>
